...
function EmployeePage() {
  ...
  const fetch_data = async () => {
    try {
      const response = await axios.get("https://demo-ch.onrender.com/employees");
    ...
    try {
      if (editingEmployee) {
        ...
        const res = await axios.put(
          `https://demo-ch.onrender.com/employees/${editingEmployee.id}`,
          empForm
        );
        setEmployees(prev =>
        ...
        const res = await axios.post(
          `https://demo-ch.onrender.com/employees`,
          empForm
        );
  ...
  const handleConfirmDelete = async () => {
    try {
      await axios.delete(`https://demo-ch.onrender.com/employees/${deleteEmployee.id}`);
